      ...
      function g() {
        let [e, t] = (0, c.useInView)({ triggerOnce: !0 }),
          ...
          w = async (e) => {
            ...
            try {
              S(!0);
              let e = await fetch("/api/consulting-form", {
                ...
                t = await e.json();
              e.ok
                ? (b(t.message || "Thank you for reaching out!"),
                  F(!1),
                  s({ firstName: "", lastName: "", email: "", message: "" }))
                : (b(t.error || "An error occurred. Please try again."), F(!0));
            } catch (e) {
              b("Network error. Please check your connection"), F(!0);
            } finally {
              S(!1);
            }
          };
